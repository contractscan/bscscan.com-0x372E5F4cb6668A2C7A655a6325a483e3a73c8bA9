 ...
 */
contract BOXCASINOTOKEN is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "BOXCASINO TOKEN";
    string private constant _SYMBOL = "BOXC";
    ...
    uint256 private _tTotal = (5**15) * _DECIMALFACTOR; // Total supply: 1 Quadrillion
    ...
    uint256 public SEND_REWARD = 300; // 3%
    uint256 public RECV_CHARGE = 300; // 3%
